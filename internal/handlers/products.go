...
//	@Param			categories	query		[]string		false	"Filter by categories"										Enums(electronics, apparel, home goods, sports, beauty, grocery, office supplies, outdoor, toys, health, automotive, luxury, books)"	default("all	categories")
